...
struct Recipe: Identifiable {
    ...
    init(name: String, image: Image?, ingredients: String, directions: String, datePublished: String, category: Category.RawValue, url: String){
        self.name = name
        self.image = image
...
extension Recipe {
    static var allRecipe: [Recipe] = [
        Recipe(
            ...
            datePublished: "",
            category: "Salade 🥗",
            url: "https://www.marmiton.org/recettes/recette_salade-de-concombre-au-chevre-et-olives_22393.aspx"
        ),
        ...
        Recipe(
            ...
            datePublished: "",
            category: "Dessert 🧁",
            url: "https://www.marmiton.org/recettes/recette_gateau-de-crepes-a-la-chantilly-et-confiture_532888.aspx"
        ),
        ...
        Recipe(
            ...
            datePublished: "",
            category: "Dessert 🧁",
            url: "https://www.marmiton.org/recettes/recette_bavarois-aux-fraises-sur-genoise_58126.aspx"
        ),
        ...
        Recipe(
            ...
            datePublished: "",
            category: "Appéritif 🍢",
            url: "https://www.marmiton.org/recettes/recette_oeufs-cocottes_66170.aspx"
        ),
